...
RSpec.describe Api::PhysicalAddressesController, type: :controller do
  ...
  let(:physical_address) {create(:physical_address, link_instance: link_instance)}
  ...
  describe "GET #show" do
    it "returns a success response" do
      get :show, params: {id: physical_address.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
    ...
    context "when logged in" do
      ...
      context "with valid params" do
        it "creates a new PhysicalAddress" do
          expect {
            post :create, params: {physical_address: valid_attributes}, session: valid_session
          }.to change(PhysicalAddress, :count).by(1)
        end
        ...
        it "renders a JSON response with the new physical_address" do
          ...
          expect(response.location).to eq(api_physical_address_url(PhysicalAddress.last))
        end
      end

      context "with invalid params" do
        it "renders a JSON response with errors for the new physical_address" do
          post :create, params: {physical_address: invalid_attributes}, session: valid_session
    ...
    context "when logged in" do
      ...
      context "with valid params" do
        ...
        it "renders a JSON response with the physical_address" do
          put :update, params: {id: physical_address.to_param, physical_address: valid_attributes}, session: valid_session
