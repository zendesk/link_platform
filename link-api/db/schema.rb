...
ActiveRecord::Schema.define(version: 20_190_109_225_559) do
  ...
  create_table 'admins', force: :cascade do |t|
    ...
    t.index %w[link_instance_id email], name: 'index_admins_on_link_instance_id_and_email', unique: true
  ...
  create_table 'link_instance_settings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[link_instance_id name], name: 'index_link_instance_settings_on_link_instance_id_and_name', unique: true
  end
