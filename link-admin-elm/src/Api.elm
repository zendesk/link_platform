...
{-| This module is responsible for communicating to the Link API.
...
get : Endpoint -> Maybe Cred -> ToMsg a msg -> Decoder a -> Cmd msg
...
put : Endpoint -> Cred -> Body -> ToMsg a msg -> Decoder a -> Cmd msg
...
post : Endpoint -> Maybe Cred -> Body -> ToMsg a msg -> Decoder a -> Cmd msg
...
delete : Endpoint -> Cred -> Body -> ToMsg a msg -> Decoder a -> Cmd msg
...
login : Http.Body -> ToMsg a msg -> Decoder (Cred -> a) -> Cmd msg
